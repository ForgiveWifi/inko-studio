      ...
      <div className="flexbox-column full-width" style={{ marginBottom: 60 }}>
        <motion.div
          ...
          <p
            ...
            inko products are printed on premium blanks, locally in the US with advanced printers.  Using inkjet technology, we are able to produce high-resolution images with vibrant colors on a variety of garments like t-shirts, hoodies, and other fabrics.   With a wide range of colors, we offer printing solutions for all your needs.
          </p>
        </motion.div>
